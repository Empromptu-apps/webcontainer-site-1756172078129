      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">
                  After I... <span className="text-gray-500 font-normal">(anchor moment)</span>
                </label>
                <input
                  type="text"
                  value={anchorMoment}
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">
                  I will... <span className="text-gray-500 font-normal">(new tiny habit)</span>
                </label>
                <input
                  type="text"
                  value={newHabit}
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">
                  And celebrate by... <span className="text-gray-500 font-normal">(optional but recommended)</span>
                </label>
                <input
                  type="text"
                  value={celebration}
              ...
              <div className="pt-6 space-y-4">
                <button
                  ...
                  className="w-full bg-green-600 hover:bg-green-700 text-white py-3 px-6 rounded-xl font-semibold disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center space-x-2 transition-colors duration-200"
          ...
          <div className="card-luxury p-8">
            ...
            <div className="h-96 border-2 border-dashed border-gray-200 dark:border-gray-600 rounded-xl p-4 overflow-y-auto mb-4 bg-gray-50 dark:bg-gray-800/50">
              {chatMessages.length === 0 ? (
                <div className="text-center text-gray-500 dark:text-gray-400 mt-16">
                  ...
                  <p className="text-sm leading-relaxed">
                    ...
                    <strong>"Validate with AI Coach"</strong> to get <br />
                ...
                <div className="space-y-4" role="log" aria-live="polite" aria-label="Chat conversation">
                    ...
                    >
                      <div
                        className={`max-w-xs lg:max-w-md px-4 py-3 rounded-2xl shadow-sm ${
                          message.type === 'user'
                            ? 'bg-primary-600 text-white chat-bubble-user'
                            : 'bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-gray-800 dark:text-gray-200 chat-bubble-ai'
                        }`}
                      >
                  ...
                  {isValidating && (
                    <div className="flex justify-start">
                      <div className="bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 px-4 py-3 rounded-2xl text-gray-600 dark:text-gray-400 shadow-sm">
